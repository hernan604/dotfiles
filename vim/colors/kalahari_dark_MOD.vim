...
if has("autocmd")
  autocmd! bufwritepost kalahari_dark_MOD.vim colorscheme kalahari_dark_MOD
endif ">>>
let g:colors_name="kalahari_dark_MOD"
...
if has("gui_running") || &t_Co == 256
 ...
 "hi SpellRare                 ctermbg=13
  hi StatusLine   ctermfg=33    ctermbg=255   cterm=reverse,bold
...
elseif &t_Co == 88
 ...
 "hi LineNr       ctermfg=11
  ...
  hi StatusLineNC ctermfg=3    ctermbg=82   cterm=none
...
"  hi StatusLine                                     cterm=bold,reverse
  hi StatusLine   ctermfg=3                    cterm=bold,reverse
